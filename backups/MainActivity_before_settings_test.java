...
settingsButton.setColorFilter(
    ...
    private void showPasswordUnlockDialog() {
        ...
        // Purple atmospheric circles.
        View glow1 = new View(this);
        GradientDrawable g1 = new GradientDrawable();
        g1.setShape(GradientDrawable.OVAL);
        g1.setColor(Color.rgb(37, 17, 83));
        glow1.setBackground(g1);
        FrameLayout.LayoutParams g1p = new FrameLayout.LayoutParams(dp(180), dp(180));
        g1p.gravity = Gravity.TOP | Gravity.CENTER_HORIZONTAL;
        g1p.topMargin = dp(120);
        root.addView(glow1, g1p);

        LinearLayout content = new LinearLayout(this);
        content.setOrientation(LinearLayout.VERTICAL);
        content.setGravity(Gravity.CENTER_HORIZONTAL);
        content.setPadding(dp(24), dp(40), dp(24), dp(34));

        FrameLayout icon = iconHolder("lock", 88);
        LinearLayout.LayoutParams ip = new LinearLayout.LayoutParams(dp(88), dp(88));
        ip.setMargins(0, dp(35), 0, dp(18));
        content.addView(icon, ip);

        TextView title = qninText("Qnin Note locked", 23, QNIN_TEXT, true);
        title.setGravity(Gravity.CENTER);
        content.addView(title, new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, dp(42)
        ));

        TextView sub = qninText("Enter your password to continue.", 14, QNIN_MUTED, false);
        ...
        LinearLayout.LayoutParams fp = (LinearLayout.LayoutParams)
                content.getChildAt(content.getChildCount() - 1).getLayoutParams();
        fp.setMargins(0, dp(24), 0, 0);
        ...
        // Bottom wave-like purple layers.
        View wave = new View(this);
        GradientDrawable waveBg = qninGradient(
                Color.rgb(18, 8, 45),
                Color.rgb(5, 5, 13),
                dp(80)
        );
        ...
        // Keep content above the decorative wave.
